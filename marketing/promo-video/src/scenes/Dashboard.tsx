...
import { MockDashboard, MOCK_DASHBOARD_RATIO } from '../components/Mock';
...
const CALLOUTS = [
  { y: 0.175, side: 'right' as const, label: '5-hour session', note: 'live % + countdown', color: COLOR.red },
...
export const Dashboard: React.FC = () => {
  ...
  if (vertical) {
    ...
    return (
      ...
      >
        ...
        <Reveal delay={12}>
          <MockDashboard theme="dark" width={w} />
        </Reveal>
  ...
  const screenW = vw(20);
  const screenH = screenW * MOCK_DASHBOARD_RATIO;
  ...
  return (
    <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center' }}>
      ...
      <MockDashboard theme="dark" width={screenW} />
