...
pub fn strings() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("Pro", "Pro");
    m.insert("Max", "Max");
    m.insert("Claude Code not detected", "Kh\u{00f4}ng t\u{00ec}m th\u{1ea5}y Claude Code");
    m.insert("credentials_not_found", "Kh\u{00f4}ng t\u{00ec}m th\u{1ea5}y th\u{00f4}ng tin \u{0111}\u{0103}ng nh\u{1ead}p");
    m.insert(
    ...
    m.insert("Open Dashboard", "M\u{1edf} b\u{1ea3}ng \u{0111}i\u{1ec1}u khi\u{1ec3}n");
    m.insert("Export History (CSV)", "Xu\u{1ea5}t l\u{1ecb}ch s\u{1eed} (CSV)");
    m.insert("Settings", "C\u{00e0}i \u{0111}\u{1eb7}t");
    m.insert("Start with Windows", "Kh\u{1edf}i \u{0111}\u{1ed9}ng c\u{00f9}ng Windows");
    m.insert("About", "Gi\u{1edb}i thi\u{1ec7}u");
    m.insert("Exit", "Tho\u{00e1}t");
    m.insert("Last updated:", "C\u{1ead}p nh\u{1ead}t l\u{1ea7}n cu\u{1ed1}i:");
    m.insert("Refresh", "L\u{00e0}m m\u{1edb}i");
    m.insert("Status", "Tr\u{1ea1}ng th\u{00e1}i");
    m.insert("Usage Alert", "C\u{1ea3}nh b\u{00e1}o s\u{1eed} d\u{1ee5}ng");
    m.insert("Usage Critical", "S\u{1eed} d\u{1ee5}ng nghi\u{00ea}m tr\u{1ecd}ng");
    m.insert(
    ...
    m.insert("Polling interval", "Kho\u{1ea3}ng th\u{1edd}i gian ki\u{1ec3}m tra");
    ...
    m.insert("Usage History (24h)", "L\u{1ecb}ch s\u{1eed} s\u{1eed} d\u{1ee5}ng (24h)");
    m.insert("Auto (English)", "T\u{1ef1} \u{0111}\u{1ed9}ng (Ti\u{1ebf}ng Vi\u{1ec7}t)");
    m.insert("at", "l\u{00fa}c");
    m.insert("Resets in", "\u{0110}\u{1eb7}t l\u{1ea1}i sau");
    m.insert("Tray icon colors:", "M\u{00e0}u bi\u{1ec3}u t\u{01b0}\u{1ee3}ng:");
    ...
    m.insert("Check for updates", "Ki\u{1ec3}m tra c\u{1ead}p nh\u{1ead}t");
    m.insert("Accessibility patterns", "M\u{1eab}u h\u{1ed7} tr\u{1ee3} ti\u{1ebf}p c\u{1ead}n");
    m.insert("Update available", "C\u{00f3} b\u{1ea3}n c\u{1ead}p nh\u{1ead}t");
    m.insert(
