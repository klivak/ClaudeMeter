...
pub fn strings() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("Show model limits", "Mostra limiti per modello");
    ...
    m.insert("stale_token_expired", "Non aggiornato — token scaduto");
    m.insert("stale_data", "Non aggiornato — ultimi valori noti");
    m.insert("codex_no_data", "Nessuna finestra di limiti Codex attiva. L'utilizzo viene letto dai log locali delle sessioni Codex: avvia o prosegui una sessione e comparirà qui.");
    m.insert("Open Codex Usage →", "Apri utilizzo Codex →");
    m.insert("Midnight", "Mezzanotte");
    m.insert("Sunset", "Tramonto");
    m.insert("Show Codex section", "Mostra sezione Codex");
    m.insert(
        "Reopen the tray popup to refresh",
        "Riapri la finestra per aggiornare",
    );
    m.insert("Show startup notification", "Mostra notifica all'avvio");
    m.insert(
        "Show login expiry warning",
        "Avvisa alla scadenza del login",
    );
    m.insert("Alert thresholds", "Soglie di avviso");
    m.insert("Notification sound", "Suono di notifica");
    m.insert("Test notification", "Notifica di prova");
    m.insert("Send", "Invia");
    m.insert("pace_projection", "Ritmo: verso ~{}% al reset");
    m.insert("pace_too_early", "Ritmo: troppo presto per una stima");
    m.insert("Open Claude Usage", "Apri utilizzo di Claude");
    m.insert("Open Config", "Apri configurazione");
    m.insert("Export Config", "Esporta configurazione...");
    m.insert("Import Config", "Importa configurazione...");
    m.insert("Enable Autostart", "Attiva avvio automatico");
    m.insert("Disable Autostart", "Disattiva avvio automatico");
    m.insert("Open Logs", "Apri i log");
    m.insert("Quit", "Esci");
    m.insert("Freshness", "Freschezza dei dati");
    m.insert("Live", "In diretta");
    m.insert("Cached", "Dalla cache / nessun dato API ancora");
    m.insert("api_error", "Errore API");
    m.insert("Refreshing", "Aggiornamento...");
    m.insert("time_ago", "{} fa");
    m.insert("latest_version", "Stai usando l'ultima versione.");
    m.insert(
        "update_check_failed",
