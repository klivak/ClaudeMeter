...
pub fn strings() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("Pro", "Pro");
    m.insert("Max", "Max");
    m.insert("Claude Code not detected", "Claude Code nem tal\u{00e1}lhat\u{00f3}");
    m.insert("credentials_not_found", "Hiteles\u{00ed}t\u{0151} adatok nem tal\u{00e1}lhat\u{00f3}k");
    m.insert(
    ...
    m.insert("Check your usage manually:", "Ellen\u{0151}rizd a haszn\u{00e1}latod manu\u{00e1}lisan:");
    m.insert("Open ChatGPT Usage \u{2192}", "ChatGPT haszn\u{00e1}lat megnyit\u{00e1}sa \u{2192}");
    m.insert("Refresh Now", "Friss\u{00ed}t\u{00e9}s most");
    m.insert("Open Dashboard", "Vez\u{00e9}rl\u{0151}pult megnyit\u{00e1}sa");
    m.insert("Export History (CSV)", "El\u{0151}zm\u{00e9}nyek export\u{00e1}l\u{00e1}sa (CSV)");
    ...
    m.insert("Auto", "Auto");
    m.insert("Show ChatGPT section", "ChatGPT szekci\u{00f3} megjelen\u{00ed}t\u{00e9}se");
    m.insert("Enabled", "Enged\u{00e9}lyezve");
    m.insert("Sound", "Hang");
    m.insert("Thresholds", "K\u{00fc}sz\u{00f6}b\u{00e9}rt\u{00e9}kek");
    m.insert("Polling interval", "Friss\u{00ed}t\u{00e9}si id\u{0151}k\u{00f6}z");
    ...
    m.insert("Open Claude.ai \u{2192}", "Claude.ai megnyit\u{00e1}sa \u{2192}");
    m.insert("ClaudeMeter", "ClaudeMeter");
    m.insert("CLAUDE", "CLAUDE");
    m.insert("CHATGPT / CODEX", "CHATGPT / CODEX");
    m.insert("Usage History (24h)", "Haszn\u{00e1}lati el\u{0151}zm\u{00e9}nyek (24\u{00f3})");
    ...
    m.insert("Check for updates", "Friss\u{00ed}t\u{00e9}sek keres\u{00e9}se");
    m.insert("Accessibility patterns", "Akad\u{00e1}lymentes\u{00ed}t\u{00e9}si mint\u{00e1}k");
    m.insert("Update available", "Friss\u{00ed}t\u{00e9}s el\u{00e9}rhet\u{0151}");
    m.insert(
